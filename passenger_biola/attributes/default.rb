...
default['passenger_biola']['nginx']['ssl_certificate'] = '/etc/ssl/certs/*.biola.edu.crt'
default['passenger_biola']['nginx']['ssl_certificate_key'] = '/etc/ssl/private/*.biola.edu.key'
