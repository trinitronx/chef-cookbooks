...
when "rhel"
  # Some packages (e.g. sharutils) on RHEL 6 require the optional repo
  if node['platform'] == 'redhat' and node['platform_version'].to_i > 5
  ...
  ['binutils','elfutils-libelf','elfutils-libelf-devel','gcc','gcc-c++','glibc-common','glibc-headers','ksh','libstdc++-devel','make','sysstat','libXtst','at','sharutils'].each do |packagename|
