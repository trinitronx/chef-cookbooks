...
# Fix to allow Net::SNMP version to be compared against integers below
my $net_snmp_version = Net::SNMP->VERSION;
$net_snmp_version =~ s/\D//g;
...
# Get load table
my $resultat = ($net_snmp_version < 4) ? 
